	...
	class rhs_6b13_crewofficer						{ quality = 2; price = 450; };
	class rhs_6b13_Flora_crewofficer				{ quality = 2; price = 450; };
	class rhs_6b13_6sh92_vog						{ quality = 2; price = 450; };
	class rhs_6b13_6sh92_headset_mapcase			{ quality = 2; price = 450; };
	class rhs_6b13_6sh92_radio						{ quality = 2; price = 450; };
	class rhs_6b13_Flora_6sh92						{ quality = 2; price = 450; };
	class rhs_6b13_EMR								{ quality = 2; price = 450; };
	class rhs_6b13									{ quality = 2; price = 450; };
	class rhs_6b13_6sh92							{ quality = 2; price = 450; };
	class rhs_6b13_EMR_6sh92						{ quality = 2; price = 450; };
	class rhs_6b13_EMR_6sh92_headset_mapcase		{ quality = 2; price = 450; };
	class rhs_6b13_EMR_6sh92_radio					{ quality = 2; price = 450; };
	class rhs_6b13_EMR_6sh92_vog					{ quality = 2; price = 450; };
	class rhs_6b13_Flora_6sh92_headset_mapcase 		{ quality = 2; price = 450; };
	class rhs_6b13_Flora_6sh92_radio 				{ quality = 2; price = 450; };
	class rhs_6b13_Flora_6sh92_vog					{ quality = 2; price = 450; };	
	...
	///////////////////////////////////////////////////////////////////////////////
	// Added by ElShotte
	class rhs_ess_black								{ quality = 2; price = 50; };
	class rhs_googles_black							{ quality = 2; price = 50; };
	class rhs_googles_clear							{ quality = 2; price = 50; };
	class rhs_googles_yellow						{ quality = 2; price = 50; };
	class rhs_googles_orange						{ quality = 2; price = 50; };
	class rhs_scarf									{ quality = 2; price = 50; };
	class rhs_balaclava								{ quality = 2; price = 50; };
	class rhs_balaclava1_olive						{ quality = 2; price = 50; };
	...
	// Added by ElShotte
	class rhs_altyn_novisor 								{ quality = 3; price = 150; };
	class rhs_altyn_novisor_bala							{ quality = 3; price = 150; };
	class rhs_altyn_novisor_ess								{ quality = 3; price = 150; };
	class rhs_altyn_novisor_ess_bala						{ quality = 3; price = 150; };
	class rhs_altyn_visordown								{ quality = 3; price = 200; };
	class rhs_altyn											{ quality = 3; price = 200; };
	class rhs_altyn_bala									{ quality = 3; price = 200; };
	class rhsusf_opscore_bk_pelt							{ quality = 3; price = 200; };
	class rhsusf_opscore_bk									{ quality = 3; price = 200; };
	class rhsusf_opscore_coy_cover							{ quality = 3; price = 200; };
	class rhsusf_opscore_coy_cover_pelt						{ quality = 3; price = 200; };
	class rhsusf_opscore_fg									{ quality = 3; price = 200; };
	class rhsusf_opscore_fg_pelt							{ quality = 3; price = 200; };
	class rhsusf_opscore_fg_pelt_cam						{ quality = 3; price = 200; };
	class rhsusf_opscore_fg_pelt_nsw						{ quality = 3; price = 200; };
	class rhsusf_opscore_mc									{ quality = 3; price = 200; };
	class rhsusf_opscore_mc_pelt							{ quality = 3; price = 200; };
	class rhsusf_opscore_mc_pelt_nsw						{ quality = 3; price = 200; };
	class rhsusf_opscore_mc_cover							{ quality = 3; price = 200; };
	class rhsusf_opscore_mc_cover_pelt						{ quality = 3; price = 200; };
	class rhsusf_opscore_mc_cover_pelt_nsw					{ quality = 3; price = 200; };
	class rhsusf_opscore_mc_cover_pelt_cam					{ quality = 3; price = 200; };
	class rhsusf_opscore_paint								{ quality = 3; price = 200; };
	class rhsusf_opscore_paint_pelt							{ quality = 3; price = 200; };
	class rhsusf_opscore_paint_pelt_nsw						{ quality = 3; price = 200; };
	class rhsusf_opscore_paint_pelt_nsw_cam					{ quality = 3; price = 200; };
	class rhsusf_opscore_rg_cover							{ quality = 3; price = 200; };
	class rhsusf_opscore_rg_cover_pelt						{ quality = 3; price = 200; };
	class rhsusf_opscore_ut									{ quality = 3; price = 200; };
	class rhsusf_opscore_ut_pelt							{ quality = 3; price = 200; };
	class rhsusf_opscore_ut_pelt_cam						{ quality = 3; price = 200; };
	class rhsusf_opscore_ut_pelt_nsw						{ quality = 3; price = 200; };
	class rhsusf_opscore_ut_pelt_nsw_cam					{ quality = 3; price = 200; };
	class rhsusf_opscore_mar_ut_pelt						{ quality = 3; price = 200; };
	class rhsusf_opscore_mar_ut								{ quality = 3; price = 200; };
	class rhsusf_opscore_mar_fg_pelt						{ quality = 3; price = 200; };
	class rhsusf_opscore_mar_fg								{ quality = 3; price = 200; };
	class rhsusf_protech_helmet								{ quality = 3; price = 200; };
	class rhsusf_protech_helmet_ess							{ quality = 3; price = 200; };
	class rhsusf_protech_helmet_rhino						{ quality = 3; price = 200; };
	class rhsusf_protech_helmet_rhino_ess					{ quality = 3; price = 200; };
	class rhsusf_cvc_green_ess								{ quality = 3; price = 200; };
	...
	class rhsusf_acc_nt4_black								{ quality = 3; price = 180; };
	...
	class rhs_acc_uuk										{ quality = 1; price = 150; };
	//MP7A2 Rotex Silencer Variations
	class rhsusf_acc_rotex_mp7 								{ quality = 3; price = 200; };
	class rhsusf_acc_rotex_mp7_desert 						{ quality = 3; price = 200; };
	class rhsusf_acc_rotex_mp7_winter 						{ quality = 3; price = 200; };
	class rhsusf_acc_rotex_mp7_aor1 						{ quality = 3; price = 200; };
	class rhs_acc_tgpv 										{ quality = 3; price = 200; };
	...
	class rhsusf_5Rnd_HE 								{ quality = 3; price = 70; };
	...
	// VSS
	class rhs_20rnd_9x39mm_SP6 							{ quality = 1; price = 65; };
	...
	class rhs_weap_m240B							{ quality = 2; price = 5000; };
	class rhs_weap_m240B_CAP						{ quality = 2; price = 5000; };
	class rhs_weap_m240G							{ quality = 2; price = 5000; };
	//Russian
	class rhs_weap_pkm								{ quality = 2; price = 5000; };
	class rhs_weap_pkp								{ quality = 2; price = 5000; };
	...
	//Russian
	//class rhs_weap_ak103							{ quality = 1; price = 250; };
	//class rhs_weap_ak103_npz						{ quality = 1; price = 250; };
	//class rhs_weap_ak103_1							{ quality = 1; price = 250; };
	//class rhs_weap_ak74m							{ quality = 1; price = 250; };
	//class rhs_weap_ak74m_2mag						{ quality = 1; price = 250; };
	...
	//class rhs_weap_ak74m_desert_folded				{ quality = 1; price = 250; };
	//class rhs_weap_ak74m_plummag_folded				{ quality = 1; price = 250; };
	//class rhs_weap_ak74m_folded						{ quality = 1; price = 250; };
	//class rhs_weap_ak74m_camo_folded				{ quality = 1; price = 250; };
	...
	// Sub Machine Guns
	///////////////////////////////////////////////////////////////////////////////
	class rhsusf_weap_MP7A2                			{ quality = 2; price = 800; };
	...
	///////////////////////////////////////////////////////////////////////////////
	//US
	class rhs_weap_sr25								{ quality = 1; price = 5000; };
	class rhs_weap_sr25_ec							{ quality = 1; price = 5000; };
	class rhs_weap_m14ebrri							{ quality = 3; price = 2000; };
	class rhs_weap_XM2010							{ quality = 3; price = 8000; };
	class rhs_weap_XM2010_wd						{ quality = 3; price = 8000; };
	class rhs_weap_XM2010_d							{ quality = 3; price = 8000; };
	class rhs_weap_XM2010_sa						{ quality = 3; price = 8000; };
	//Russian
	class rhs_weap_svd								{ quality = 2; price = 2000; };
	class rhs_weap_svdp_wd							{ quality = 2; price = 2000; };
	class rhs_weap_svdp_wd_npz						{ quality = 2; price = 2000; };
	class rhs_weap_svdp_npz							{ quality = 2; price = 2000; };
	class rhs_weap_svds								{ quality = 2; price = 2000; };
	class rhs_weap_svds_npz							{ quality = 2; price = 2000; };
	// Added by ElShotte
	class rhs_weap_M107   							{ quality = 3; price = 12500; sellPrice = 4000; };
	class rhs_weap_M107_d   						{ quality = 3; price = 12500; sellPrice = 4000; };
	class rhs_weap_M107_w   						{ quality = 3; price = 12500; sellPrice = 4000; };
	class rhs_weap_t5000   							{ quality = 3; price = 8500; };
	class rhs_weap_m24sws   						{ quality = 3; price = 5000; };
	class rhs_weap_m24sws_blk   					{ quality = 3; price = 5000; };
	class rhs_weap_m24sws_ghillie   				{ quality = 3; price = 5000; };
	class rhs_weap_m40a5   							{ quality = 3; price = 5000; };
	class rhs_weap_m40a5_d   						{ quality = 3; price = 5000; };
	class rhs_weap_m40a5_w   						{ quality = 3; price = 5000; };
	class rhs_weap_sr25_d 							{ quality = 3; price = 5100; };
	class rhs_weap_sr25_wd 							{ quality = 3; price = 5100; };
	class rhs_weap_sr25_ec_d 						{ quality = 3; price = 5100; };
	class rhs_weap_sr25_ec_wd 						{ quality = 3; price = 5100; };
	class rhs_weap_vss_grip 						{ quality = 3; price = 5100; };
	class rhs_weap_vss_grip_npz 						{ quality = 3; price = 1100; };

	///////////////////////////////////////////////////////////////////////////////
	// Launcher
	///////////////////////////////////////////////////////////////////////////////
	class rhs_weap_rpg26  							{ quality = 3; price = 15000; sellPrice = 5500; };
	class rhs_weap_rpg7  							{ quality = 3; price = 12000; sellPrice = 8000; };
	class rhs_weap_rshg2  							{ quality = 3; price = 7500; sellPrice = 5500; };
	class rhs_weap_igla 							{ quality = 3; price = 75000; sellPrice = 25000; };
	class rhs_weap_fgm148 							{ quality = 3; price = 60000; sellPrice = 15000; };
	class rhs_weap_fim92 							{ quality = 3; price = 75000; sellPrice = 25000;  };
	class rhs_weap_M136 							{ quality = 3; price = 20000; sellPrice = 10000; };
	class rhs_weap_M136_hedp 						{ quality = 3; price = 20000; sellPrice = 10000; };
	class rhs_weap_M136_hp 							{ quality = 3; price = 20000; sellPrice = 10000; };
	class rhs_weap_m72a7 							{ quality = 3; price = 10000; sellPrice = 8500; };
	class rhs_weap_smaw 							{ quality = 3; price = 20000; sellPrice = 10000; };
	class rhs_weap_smaw_green 						{ quality = 3; price = 20000; sellPrice = 10000; };
	...
	// Added by ElShotte
	class rhs_rpg7_type69_airburst_mag 				{ quality = 3; price = 5000; };
	class rhs_fgm148_magazine_AT 					{ quality = 3; price = 5000; };
	class rhs_fim92_mag 							{ quality = 3; price = 5000; };
	class rhs_m136_mag 								{ quality = 3; price = 5000; };
	class rhs_m136_hedp_mag 						{ quality = 3; price = 5000; };
	class rhs_M136_hp_mag 							{ quality = 3; price = 5000; };
	class rhs_m72a7_mag 							{ quality = 3; price = 5000; };
	class rhs_mag_smaw_HEAA 						{ quality = 3; price = 5000; };
	class rhs_mag_smaw_HEDP 						{ quality = 3; price = 5000; };
	class rhs_mag_smaw_SR 							{ quality = 3; price = 5000; };
	
	///////////////////////////////////////////////////////////////////////////////
	// Mines
	///////////////////////////////////////////////////////////////////////////////
	class rhsgref_mag_rkg3em						{ quality = 4; price = 5000; };
	class rhsusf_mine_m14_mag 						{ quality = 4; price = 10000; };
	class rhsusf_m112_mag 							{ quality = 4; price = 15000; };
	class rhs_mine_pmn2_mag 						{ quality = 4; price = 15500; };
	class rhs_mine_tm62m_mag 						{ quality = 4; price = 15500; };
	class rhs_mine_m19_mag 							{ quality = 4; price = 15500; };
	class rhsusf_m112x4_mag							{ quality = 4; price = 18000; };
	
	///////////////////////////////////////////////////////////////////////////////
	// Grenades
	///////////////////////////////////////////////////////////////////////////////
	// Added by ElShotte
	class rhs_mag_f1								{ quality = 4; price = 250; };
	...
	class rhs_mag_m18_purple 						{ quality = 2; price = 150; };
	class rhs_mag_m18_red 							{ quality = 2; price = 150; };
	class rhs_mag_m18_yellow 						{ quality = 2; price = 150; };
	class rhs_mag_m67 								{ quality = 4; price = 250; };
	class rhs_mag_m7a3_cs 							{ quality = 3; price = 200; };
	class rhs_mag_mk84 								{ quality = 3; price = 200; };
	class rhs_mag_mk3a2 							{ quality = 3; price = 200; };
	...
	class rhs_mag_rgn 								{ quality = 4; price = 250; };
	class rhs_mag_rgo 								{ quality = 4; price = 250; };
	class rhs_mag_zarya2 							{ quality = 2; price = 150; };
	class rhs_mag_an_m8hc 							{ quality = 1; price = 100; };
	class rhs_mag_an_m14_th3 						{ quality = 4; price = 150; };

	///////////////////////////////////////////////////////////////////////////////
	// Underbarrel GL Ammunition
	///////////////////////////////////////////////////////////////////////////////
	// Added by ElShotte
